...
//  BandhanStar2
//
//  Created by Jeny on 26/08/17.
//  Copyright © 2017 krupa. All rights reserved.
//
...
/**
 - Parameter string: Key to be localized from specific Strings file
 - Returns: The localized string.
 */
public func Localized(_ string: String ,_ stringsFileName : String) -> String {
    return string.localized(using: stringsFileName, in: Bundle.main)
}
